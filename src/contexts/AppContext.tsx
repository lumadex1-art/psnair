    ...
    try {
      ...
      if (data.success) {
        ...
        if (firestoreData) {
          ...
          setState((prevState) => {
            const planFeatures = PLAN_CONFIG.FEATURES[prevState.userTier];
            const rewardAmount = planFeatures?.rewardPerClaim || 1;
          ...
          setState((prevState) => {
            const planFeatures = PLAN_CONFIG.FEATURES[prevState.userTier];
            const fallbackReward = planFeatures?.rewardPerClaim || 1;
