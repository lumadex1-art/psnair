...
const plans = [
  {
    ...
    features: ['5 EPSN per day', 'Lifetime access', 'Priority Support'],
    isPopular: false,
  },
  {
    name: 'Silver' as Tier,
    ...
    features: ['10 EPSN per day', 'Lifetime access', 'Faster Cooldowns', 'Priority Support'],
    isPopular: true,
  },
  {
    name: 'Gold' as Tier,
    ...
    features: ['20 EPSN per day', 'Lifetime access', 'Exclusive Tools Access', 'Gold Badge'],
    isPopular: false,
  },
  {
    ...
    features: ['50 EPSN per day', 'Lifetime access', 'All Exclusive Tools', 'Platinum Community Access', 'Highest Priority Support'],
    isPopular: false,
  },
  {
    name: 'Diamond' as Tier,
    usdPrice: 39.99,
    description: 'For ultimate power users who want maximum rewards.',
    features: ['100 EPSN per day', 'Lifetime access', 'All Exclusive Tools', 'Diamond Community Access', 'VIP Support', 'Exclusive NFT Access'],
    isPopular: false,
  },
];
                    ...
                    <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200/50 dark:border-green-800/50">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-green-600 dark:text-green-400">
                          {plan.name === 'Starter' ? '5x' : 
                           plan.name === 'Silver' ? '10x' : 
                           plan.name === 'Gold' ? '20x' : 
                           plan.name === 'Platinum' ? '50x' :
                           plan.name === 'Diamond' ? '100x' : '1x'}
                        </p>
